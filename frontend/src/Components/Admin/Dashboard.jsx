...
const AdminDashboard = () => {
  ...
  const recentOrders = [...(orders || [])]
    .filter((order) => !!order.dateOfPurchase)
    .sort(
      (a, b) =>
        dayjs(b.dateOfPurchase, "DD/MM/YYYY").valueOf() -
        dayjs(a.dateOfPurchase, "DD/MM/YYYY").valueOf()
    )
                ...
                recentOrders.map((order) => (
                  <Fragment key={order.id}>
                    <div className="dashBoardProfile child">
                      ...
                      <p className="dashBoardName child">{order.name}</p>
                    </div>
