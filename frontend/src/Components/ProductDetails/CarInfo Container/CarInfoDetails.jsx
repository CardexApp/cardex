  ...
  return (
    <div className="car-info-details">
      ...
      <section className="section-block">
        <h3>Description</h3>
        <p>
          The Toyota Camry 2023 is engineered for comfort and style. It features
          advanced safety technology, a spacious interior, and powerful
          performance making it ideal for families and professionals alike.
        </p>
      </section>
